    ...
    def static manifestPath(Project project, String variantDir) {
        ...
        if (processManifestTask) {
            ...
            try {
                ...
                println ">>> step into exception : ${e}"
                String manifestPath = "$processManifestTask.manifestOutputDirectory/AndroidManifest.xml"
                String instantRunManifestPath = "$processManifestTask.instantRunManifestOutputDirectory/AndroidManifest.xml"
                manifestOutputFile = new File(manifestPath)
                instantRunManifestOutputFile = new File(instantRunManifestPath)
